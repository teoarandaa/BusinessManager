...
fileprivate struct OnboardingPage {
    let title: String
    let subtitle: String
...
struct OnboardingView: View {
    ...
    fileprivate var onboardingPages: [OnboardingPage] {
        [
            OnboardingPage(
    ...
    var body: some View {
        Group {
            if showLanguageSelection {
                LanguageSelectionView(showLanguageSelection: $showLanguageSelection, showOnboarding: $showOnboarding)
            } else {
                NavigationStack {
